...
@ComponentScan(basePackages = {"iitm.dcp", "com.dcp", "com.ms"})
@Configuration
public class DispatchConfiguration {
    ...
    @Bean
    public ProducerFactory<String, Object> producerFactory(@Value("${kafka.bootstrap-servers}") String bootstarpServers) {
        Map<String, Object> config = new HashMap<>();
